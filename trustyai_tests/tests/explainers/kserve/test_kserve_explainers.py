...
class TestExplainers:
    def test_bank_churn_model_prediction(self, model_namespace: Namespace, model: InferenceService):
        verify_model_prediction(model_namespace=model_namespace, model=model)

    def test_request_lime(self, model_namespace: Namespace, bank_churn_model_lime: InferenceService):
        verify_saliency_explanation(model_namespace=model_namespace, model=bank_churn_model_lime)

    def test_request_shap(self, model_namespace: Namespace, bank_churn_model_shap: InferenceService):
